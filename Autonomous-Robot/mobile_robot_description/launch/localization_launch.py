...
def generate_launch_description():
    ...
    bringup_dir = get_package_share_directory('mobile_robot_description')
    ...
    declare_map_yaml_cmd = DeclareLaunchArgument(
        'map', default_value=os.path.join(bringup_dir, 'maps', 'map_save.yaml'), description='Full path to map yaml file to load'
    )
